...
const ReceiptModal = ({ entry, onClose }) => {
  ...
  const pdfUrl  = `https://jewle-chain-backend.vercel.app/api/gold-entries/${entry._id}/pdf`;
          ...
          {!loading && entries.map(entry => (
            <div key={entry._id} style={{ background:theme.surfaceAlt, border:`1px solid ${theme.borderGold}`, borderRadius:12, padding:18, marginBottom:12 }}>
              ...
              <div style={{ display:"flex", gap:8, alignItems:"center", flexWrap:"wrap" }}>
                ...
                <a href={`https://jewle-chain-backend.vercel.app/api/gold-entries/${entry._id}/pdf`} target="_blank" rel="noreferrer"
